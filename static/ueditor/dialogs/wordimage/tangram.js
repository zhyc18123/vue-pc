...
//
//      http:// tangram.BaiduMap.vue.com/license.html
//
 ...
 * @function
 * @grammar BaiduMap.vue.array.each(source, iterator[, thisObject])
 ...
 * @function
 * @grammar BaiduMap.vue.lang.isFunction(source)
 ...
 * @function
 * @grammar BaiduMap.vue.lang.isString(source)
 * @param {Any} source 目标参数
 * @shortcut isString
 * @meta standard
 ...
 * @grammar BaiduMap.vue.browser.opera
 * @meta standard
 ...
 * @function
 * @grammar BaiduMap.vue.dom.insertHTML(element, position, html)
 ...
 * @grammar BaiduMap.vue.swf.version
 * @return {String} 版本号
 * @meta standard
 */
 ...
 * @function
 * @grammar BaiduMap.vue.string.encodeHTML(source)
 ...
 * @function
 * @grammar BaiduMap.vue.swf.createHTML(options)
 *
 ...
 * @function
 * @grammar BaiduMap.vue.swf.create(options[, container])
 *
 * @param {Object} 	options 					创建flash的选项参数
 * @param {string} 	options.id 					要创建的flash的标识
 * @param {string} 	options.url 				flash文件的url
 ...
 * @field
 * @grammar BaiduMap.vue.browser.ie
 ...
 * @function
 * @grammar BaiduMap.vue.array.remove(source, match)
 ...
 * @function
 * @grammar BaiduMap.vue.lang.isArray(source)
 * @param {Any} source 目标参数
 * @meta standard
 ...
 * @function
 * @grammar BaiduMap.vue.lang.toArray(source)
 ...
 * @function
 * @grammar BaiduMap.vue.swf.getMovie(name)
 ...
 * @class
 * @grammar BaiduMap.vue.flash.imageUploader(options)
 ...
 * @function
 * @grammar BaiduMap.vue.object.extend(target, source)
 ...
 * @class
 * @grammar BaiduMap.vue.flash.fileUploader(options)
 ...
 * @function
 * @grammar BaiduMap.vue.sio.callByBrowser(url, opt_callback, opt_options)
 ...
 * @function
 * @grammar BaiduMap.vue.sio.callByServer(url, callback[, opt_options])
 * @param {string} url 加载数据的url.
 ...
 * @function
 * @grammar BaiduMap.vue.sio.log(url)
 ...
 * Copyright 2009 Baidu Inc. All rights reserved.
 *
 * path: BaiduMap.vue/json/parse.js
 * author: erik, berg
 * version: 1.2
 * date: 2009/11/23
 */
 ...
 * @function
 * @grammar BaiduMap.vue.json.parse(data)
 ...
 * Copyright 2009 Baidu Inc. All rights reserved.
 *
 * path: BaiduMap.vue/json/decode.js
 * author: erik, cat
 * version: 1.3.4
 * date: 2010/12/23
 */
 ...
 * @function
 * @grammar BaiduMap.vue.json.decode(source)
 * @param {string} source 需要解析的字符串
 * @meta out
 ...
 * Copyright 2009 Baidu Inc. All rights reserved.
 *
 * path: BaiduMap.vue/json/stringify.js
 * author: erik
 * version: 1.1.0
 * date: 2010/01/11
 */
 ...
 * @function
 * @grammar BaiduMap.vue.json.stringify(value)
 ...
 * Copyright 2009 Baidu Inc. All rights reserved.
 *
 * path: BaiduMap.vue/json/encode.js
 * author: erik, cat
 * version: 1.3.4
 * date: 2010/12/23
 */
 ...
 * @function
 * @grammar BaiduMap.vue.json.encode(value)
 * @param {JSON} value 需要序列化的json对象
 * @meta out
