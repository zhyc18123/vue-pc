UE.registerUI('chem', function(editor, uiname){

    // 创建dialog
    var kfDialog = new UE.ui.Dialog({

        // 指定弹出层路径
        iframeUrl: editor.options.UEDITOR_HOME_URL + 'chem-plugin/indraw_online/index.html',
        // 编辑器实例
        editor: editor,
        // dialog 名称
        name: uiname,
        ...
        // dialog 外围 css
        cssRules: 'width:1000px; height: 600px;',
...
window.kfDialog=kfDialog;
    editor.ready(function(){
        UE.utils.cssRule('kfformula', 'img.kfformula{vertical-align: middle;}', editor.document);
    });

    var iconUrl = editor.options.UEDITOR_HOME_URL + 'chem-plugin/chem.png';
